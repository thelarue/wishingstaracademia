...
default affection = { # This is another dictionary. This one specifically stores info about the LI and their affection for MC. Seems good to keep these apart.
    ...
    "Felix": 5,
    "Teddy": 15
} # Though it is called affection, this is really more like affinity, like, how much stuff you have in common. Will change in a next build post jam, if it seems like anyone wants to continue work!
...
default flags = { # This is a flag system, basically just try to remember what flag goes where!
    ...
    "Grants Visited": False, # Has MC visited Sport Club yet?
